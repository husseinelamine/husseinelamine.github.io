...
function animate() {
	...
	bulbLights[0].position.x = Math.sin(time * 0.7) * 3;
	bulbLights[0].position.y = Math.cos(time * 0.5) * 4;
	bulbLights[0].position.z = Math.cos(time * 0.3) * 3;

    bulbLights[1].position.x = Math.sin(time * 0.3) * 3;
    bulbLights[2].position.z = Math.cos(time * 0.5) * 3;
    bulbLights[3].position.x = Math.cos(time * 0.7) * 3;
